...
export default async function ContactPage() {
  ...
  return (
    <div className="bg-accent2 relative flex flex-col justify-between pb-2">
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-center bg-no-repeat object-cover py-20">
        ...
        <div className="z-10 flex w-full max-w-2xl flex-col">
          <h2 className="font-semibold text-white">{contact.contactHeader}</h2>
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                id="name"
                required
                className="bg-accent2/60 border-2 border-gray-300  px-4 py-4 text-white outline-gray-400/70 backdrop-blur-md placeholder:text-slate-200 focus:border-gray-100"
              />
            </div>
            <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                cols={33}
                required
                className="bg-accent2/60 resize-none rounded-md border-2 border-gray-300 px-4 py-4 text-white outline-gray-100 ring-0 backdrop-blur-md placeholder:text-slate-200 focus:border-gray-100"
              />
            </div>
